...
public:
    ...
    */
    ...
    /**
     * @brief Calculates the Haversine distance between two points specified by latitude and longitude. Complexity O(1)
     *
    ...
    /**
     * @brief Computes an approximate solution to the TSP using MST and preorder traversal. Complexity O(V + E), where V is the number of vertices and E is the number of edges.
     *
    ...
    /**
     * @brief Computes the Minimum Spanning Tree of the graph starting from a given root vertex using Prim's algorithm. Complexity O((V + E) log V), where V is the number of vertices and E is the number of edges.
     *
    ...
    /**
     * @brief Calculates the total weight of a triangular tour through the given points. Complexity O(n), where n is the number of points in the vector.
     *
    ...
    /**
     * @brief Solves the TSP using a heuristic approach based on clustering and greedy traversal. Complexity: O(V^2), where V is the number of vertices in the graph.
     *
    ...
    /**
     * @brief Finds the nearest vertex from a specified vertex among a set of candidates. Complexity: O(n), where n is the number of candidates.
     *
    ...
    /**
     * @brief Calculates the total distance of a tour within a cluster using a greedy algorithm. Complexity: O(V^2), where V is the number of vertices in the cluster.
     *
     ...
     * be formed, it returns -1. Complexity O(V^2), where V is the number of vertices.
     *
     */
